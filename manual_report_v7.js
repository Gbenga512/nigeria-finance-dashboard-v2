/* ReconAI — authoritative bank reconciliation working paper v8 */
(function(){
  function install(){
    ...
    $('report').innerHTML=`
      ...
      <div class="tablewrap" style="margin-top:14px"><table><tbody>
        ...
        <tr><td colspan="4"><i>Memo: ${r.reversals?.length?`${r.reversals.length} failed/reversed (self-cancelling) transfer group(s) identified.`:'No failed/reversed (self-cancelling) transfer groups identified.'}</i></td></tr>
      </tbody></table></div>
